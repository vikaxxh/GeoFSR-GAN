...
from models import ImprovedSpatialSR
...
def train_improved_spatial(config_path):
    ...
    print(f"[Improved Spatial SR Training] Seed: {seed} | Device: {device}")
    ...
    epochs = 10
    print(f"\n=======================================================")
    print(f"  Starting Improved Spatial SR Training ({epochs} Epochs)  ")
    print(f"=======================================================\n")
    ...
    ckpt_path = os.path.join(ckpt_dir, "improved_spatial_sr_latest.pth")
    torch.save(model.state_dict(), ckpt_path)
    print(f"[Improved Spatial SR] Saved trained model to '{ckpt_path}'.")
...
if __name__ == "__main__":
    ...
    train_improved_spatial(args.config)
